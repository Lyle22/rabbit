...
/**
 * The type of database source configuration.
 *
 * @author weltuser
 */
@Configuration
...
@EnableJpaRepositories(
        ...
        basePackages = {"org.rabbit.workflow.repository"})
public class WorkflowDataSourceConfiguration {
    ...
    @ConfigurationProperties(prefix = "spring.datasource.docpal")
    ...
    @ConfigurationProperties("spring.datasource.docpal.configuration")
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
        ...
        return primaryEntityManagerFactoryBuilder
                ...
                .packages("com.wclsolution.docpal.api.dbmodel")
