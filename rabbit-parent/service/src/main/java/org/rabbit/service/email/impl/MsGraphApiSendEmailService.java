...
import org.rabbit.service.email.microsoft.MicrosoftOAuth2AuthenticationService;
import org.rabbit.service.email.models.*;
...
public class MsGraphApiSendEmailService implements ISendEmailService {
    ...
    public boolean match(OAuth2SettingRequestDTO setting) {
        return OAuthWay.MICROSOFT_OFFICE_365 == setting.getAuthenticationMethod();
    }
